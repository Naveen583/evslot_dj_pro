mysqldump.exe : mysqldump: [Warning] Using a password on the command 
line interface can be insecure.
At line:1 char:1
+ & "C:\Program Files\MySQL\MySQL Server 8.0\bin\mysqldump.exe" -u root 
...
+ ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    + CategoryInfo          : NotSpecified: (mysqldump: [War...an be ins 
   ecure.:String) [], RemoteException
    + FullyQualifiedErrorId : NativeCommandError
 
-- MySQL dump 10.13  Distrib 8.0.45, for Win64 (x86_64)
--
-- Host: localhost    Database: ev_charging
-- ------------------------------------------------------
...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$1200000$HCH79PZTihP8NFflgqASJj$CQlkqIj75kkCSj60Bxeg8qorH/Hpd8YkC/7yQ+0OVvI=','2026-04-08 05:22:09.960418',1,'Naveen_Admin','','','naveen@gmail.com',1,1,'2026-04-05 08:05:58.646006');
...
INSERT INTO `django_admin_log` VALUES (1,'2026-04-05 09:24:41.999980','yuva','EVRegister object (yuva)',2,'[{\"changed\": {\"fields\": [\"Name\"]}}]',9,1);
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(2,'auth','group'),(3,'auth','permission'),(4,'auth','user'),(7,'charging','evadmin'),(8,'charging','evbooking'),(9,'charging','evregister'),(10,'charging','evstation'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
INSERT INTO `django_session` VALUES ('4bp8qc2rdezgb0gqq5dl70puceve0rj8','eyJ1c2VyIjoiTmF2ZWVuQCJ9:1wBSoX:kJo7EsWndXZ3vwmIbSowMF740QDoPyrg7IWSfyjZyKY','2026-04-12 07:31:33.936204'),('v7jtyxacwjdvbb3j2ca40l12y6sy4z15','.eJxVjs0KgzAQhN9lzxJMNRo99t5nkN2N0fQnARMtpfTdS8SLp4GZj4_5ApqX89AfWcCAa5qHNY7L4Az0IM8dIT9GnwdzRz8FwcGnxZHIiDjWKG7BjM_rwZ4EM8Y5azvWpbTWaOLOYq3sRZVGl9QQt6RQVa2tWmkr1iSxwY60xNKokRpW3OVXWQc9fNYNoQAK4eH8tJ-uC4gJkwt-CG-_Uxs6-P0BcfJOrA:1w9JiV:5EtLkBGJMSkh4xl18TzMWcHtS1mXWfZ9V74no9zqdpI','2026-04-06 09:24:27.826247');
...
INSERT INTO `ev_admin` VALUES ('admin','admin@');
...
LOCK TABLES `ev_booking` WRITE;
/*!40000 ALTER TABLE `ev_booking` DISABLE KEYS */;
INSERT INTO `ev_booking` VALUES (3,'navven','vai','tn46','1',3,'evch.jpg',5,3,300.00,'14:25','14:30','2026-04-05','2026-04-05','',0,0,5,0,3,'Cash',1,3,'14:25','14:30',0,300,'2026-04-05 09:00:51',0),(4,'yuva','vai','tn46','1',3,'evch.jpg',5,3,300.00,'20:45','20:50','2026-04-05','2026-04-05','',0,0,5,0,3,'',0,1,'20:45','20:50',0,300,'2026-04-05 09:14:45',0);
...
LOCK TABLES `ev_register` WRITE;
/*!40000 ALTER TABLE `ev_register` DISABLE KEYS */;
INSERT INTO `ev_register` VALUES ('Naveen','Perambalur ',6379241960,'naveenceo86@gmail.com','Naveen@','Naveen@123','','','','','',10000),('navven','siruvachur',5646456411,'naveenarul783@gmail.com','navven','naveen','','','','','',10000),('yuva','perambalur',8610725539,'raj366089@gmail.com','yuva','yuva@','','','','','',10000);
...
-- Dump completed on 2026-04-13 10:51:02
